...
AcceptEnv SIGN_KEY
SetEnv AUTHORIZED_KEYS_DIR=$AUTHORIZED_KEYS_DIR KUBERNETES_SERVICE_HOST=$KUBERNETES_SERVICE_HOST KUBERNETES_SERVICE_PORT=$KUBERNETES_SERVICE_PORT

# creates an env var with the user's public key
ExposeAuthInfo yes
